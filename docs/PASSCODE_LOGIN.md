...
1. Driver enters **5-digit driver ID** and **6-digit passcode** (OTP-style boxes, passcode shown as `XXX–XXX`) from admin.
...
| Message | Cause |
|---------|--------|
| Invalid driver ID or passcode | Wrong ID/PIN or driver not found |
