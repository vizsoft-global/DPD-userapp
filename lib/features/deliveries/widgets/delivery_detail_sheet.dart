...
class _DeliveryDetailSheetState extends ConsumerState<DeliveryDetailSheet> {
  ...
  void initState() {
    super.initState();
    if (widget.delivery.hasOrderProof) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        unawaited(_loadProofUrl());
      });
    }
  }

  Future<void> _loadProofUrl() async {
    final key = widget.delivery.orderProofUrl?.trim();
          ...
          child: Column(
            ...
            children: [
              ...
              _ProofPreview(
                ...
                error: _proofError,
                hasProof: delivery.hasOrderProof,
                l10n: l10n,
              ),
            ],
          ),
